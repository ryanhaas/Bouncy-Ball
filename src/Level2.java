...
public class Level2 extends Level implements KeyListener, ActionListener, MouseListener, MouseMotionListener {
	...
	private void addPlatforms() {
		...
		platforms.add(new Platform(285, 245, 150, height, Platform.NORMAL));
		platforms.add(new Platform(174, 215, 50, height, Platform.NORMAL));
		platforms.add(new Platform(130, 175, 50, height, Platform.NORMAL));
	}
	...
	private void addStars() {
		...
		int startAngle = 55;
		int vertexes = 5;
		stars.add(new StarPolygon(135, 175 - size, size, (2*size)/5, vertexes, startAngle));
	}
