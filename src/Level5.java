...
public class Level5 extends Level implements KeyListener, ActionListener, MouseListener, MouseMotionListener {
	...
	private void addPlatforms() {
		...
		int height = 10;
		platforms.add(new Platform(0, env.getHeight() - 20, 65, height, Platform.NORMAL));
		platforms.add(new Platform(70, 250, 30, height, Platform.NORMAL));
		platforms.add(new Platform(105, 220, 100, height, Platform.NORMAL));
		platforms.add(new Platform(220, env.getHeight() - 20, 60, height, Platform.NORMAL));
		platforms.add(new Platform(150, env.getHeight() - 20, 30, height, Platform.NORMAL));
		platforms.add(new Platform(280, env.getHeight() - 20, 60, height, Platform.BOOST));
		platforms.add(new Platform(330, 230, 30, height, Platform.BOOST));
		platforms.add(new Platform(290, 170, 30, height, Platform.NORMAL));
	}
	private void addStars() {
		...
		int startAngle = 55;
		int vertexes = 5;
		stars.add(new StarPolygon(150, 220 - size, size, (2*size)/5, vertexes, startAngle));
		stars.add(new StarPolygon(165, 280 - size, size, (2*size)/5, vertexes, startAngle));
		stars.add(new StarPolygon(305, 170 - size, size, (2*size)/5, vertexes, startAngle));
	}
