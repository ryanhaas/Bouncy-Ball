...
public class Level3 extends Level implements KeyListener, ActionListener, MouseListener, MouseMotionListener {
	...
	private void drawInfo(Graphics2D g2d) {
		...
		String s = "Note: Blue Platforms are Jump Platforms that";
		g2d.drawString(s, 10, fontY);
		fontY += fm.getHeight();
		s = "will give you a boost";
		g2d.drawString(s, 10 + fm.stringWidth("Note: "), fontY);
	}
	...
	private void addPlatforms() {
		...
		platforms.add(new Platform(160, 245, 150, height, Platform.BOOST));
		platforms.add(new Platform(340, 165, 90, height, Platform.NORMAL));
	}
	...
	private void addStars() {
		...
		int startAngle = 55;
		int vertexes = 5;
		stars.add(new StarPolygon(120, 275 - size, size, (2*size)/5, vertexes, startAngle));
		stars.add(new StarPolygon(400, 165 - size, size, (2*size)/5, vertexes, startAngle));
	}
