...
public class Level8 extends Level implements KeyListener, ActionListener, MouseListener, MouseMotionListener {
	...
	private void drawInfo(Graphics2D g2d) {
		...
		String s = "Note: Red walls will kill you and will reset the level";
	...
	private void addPlatforms() {
		...
		platforms.add(new Platform(100, env.getHeight() - 20 - 30, 8, 30, Platform.DEAD));
	}
	private void addStars() {
		...
		int startAngle = 55;
		int vertexes = 5;
		stars.add(new StarPolygon(80, env.getHeight() - 20 - size, size, (2*size)/5, vertexes, startAngle));
		stars.add(new StarPolygon(300, env.getHeight() - 20 - size, size, (2*size)/5, vertexes, startAngle));
	}
